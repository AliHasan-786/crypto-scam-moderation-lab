...
echo "[1/14] Auditing the original labeler"
"$PYTHON_BIN" audit_original_labeler.py > audit_outputs/original_labeler_audit.json

echo "[2/14] Training and evaluating the reproducible baseline"
...
echo "[3/14] Running scenario and adversarial evals"
...
echo "[4/14] Running production-hardening evals"
...
echo "[5/14] Running controlled mutation tests"
...
echo "[6/14] Checking evidence extraction"
...
echo "[7/14] Generating governance and transparency metrics"
...
echo "[8/14] Generating operations analytics"
...
echo "[9/14] Running reviewer calibration"
...
echo "[10/14] Running incident-response tabletop checks"
...
echo "[11/14] Refreshing campaign intelligence"
...
echo "[12/14] Running standing error analysis (failures are published, guards enforced)"
...
echo "[13/14] Comparing baseline vs cached LLM evidence adapter"
...
echo "[14/14] Enforcing the release gate"
